...
## [2026-06-08] ingest | 원달러 환율 2008 금융위기 최고점 — 김광석 긴급 분석
- 처리 파일: 1개 (LIVE 원달러 환율, 2008년 금융위기 이후 최고점)
- 생성 소스 페이지: 1개 (원달러환율-2008금융위기-최고점-김광석)
- 생성 엔티티: 1명 (김광석 — 한국경제산업연구원 경제연구실장)
- 업데이트: 원달러-환율.md 개념 (달러 인덱스 디커플링·구조적 원인 섹션 추가)
- wiki 74→76 (+2), sources 29→30 (+1)
...
## [2026-05-18] ingest | 화장품창업가이드 QnA ATOZ 10부작 — 올코스

- 원본: `raw/화장품/` EP01~EP10 (10개 파일)
- 신규 생성 (2개):
  - `wiki/sources/화장품창업-가이드-올코스.md` — EP별 핵심 내용, 용어 정리, 전체 흐름
  - `wiki/concepts/화장품-창업-가이드.md` — 책임판매업자·OEM/ODM·가격책정·채널·죽음의 계곡·해외 우선 전략
- 도메인 신설: 창업/화장품
- 총 wiki 페이지: 63 → 65 (+2), 소스: 24 → 25 (+1)
- 연결: [[concepts/1인-saas-창업]]과 공통 창업 패턴(죽음의 계곡, 브랜딩, PMF) 크로스 레퍼런스

## [2026-05-18] ingest | 김시덕 도시문헌학자 18개 영상 + 드라마 명대사 3개 배치 처리

- 대상: `raw/external/` 김시덕 관련 18개 + `raw/external/명대사/` 3개 = 21개
- 처리 방식: 20개 초과 → 도메인별 그룹화 (김시덕: entity+2소스+1개념 / 명대사: 1소스)
- 신규 생성 (5개):
  - `wiki/entities/people/김시덕.md` — 도시문헌학자 프로필
  - `wiki/sources/김시덕-서울확장-부동산전략.md` — 서울 남쪽 확장론, 반도체 벨트, GTX 분석 (18개 영상 통합)
  - `wiki/sources/김시덕-위험지역-경고.md` — 강남 구조 한계, 위험 지역 목록, 지방 소멸
  - `wiki/concepts/서울-부동산-도시전략.md` — 확장 강남 벨트, 투자 체크리스트
  - `wiki/sources/드라마-명대사-나의해방일지-나의아저씨.md` — 두 드라마 명대사 클립
- 도메인 신설: 부동산/도시
- 총 wiki 페이지: 57 → 63 (+6), 소스: 21 → 24 (+3), 인물: 5 → 6 (+1)
